...
contract OneRingVault is ERC20, Ownable {
    ...
    constructor(
        address[1] memory _underlyings,
        address activeStrategyAddr,
        uint256 totalSupply
    ) ERC20("One Ring Share", "OShare") {
        ...
        activeStrategy = activeStrategyAddr;
    }
    ...
    function _getDecimaledUnderlyingBalance(
        address _underlying
    ...
    function _getDefaultMinimumAmountForDeposit(
        uint256 _amount,
        address _token
    ) internal returns (uint256 _minAmount) {

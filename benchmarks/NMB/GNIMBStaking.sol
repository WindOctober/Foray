...
contract GNIMBStaking is IStakingRewards, ReentrancyGuard, Ownable, Pausable {
    ...
    // We use false here to trigger another error statement but it is more clear to be understood.
    bool public usePriceFeeds = false;

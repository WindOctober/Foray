...
contract Haven is IBEP20, Auth {
    ...
    string constant _name = "Haven Token";
    string constant _symbol = "$HAVEN";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaleContract = msg.sender;
    ...
    function afterDeploy(address routerAddr, address pairAddr, address wbnbAddr) public {

...
/**
         ...
         ___   _  __ ________  __  ______       ____  ____  ___________ ___    __    ______
   /   | | |/ //  _/ __ \/  |/  /   |     / __ \/ __ \/ ____/ ___//   |  / /   / ____/
  / /| | |   / / // / / / /|_/ / /| |    / /_/ / /_/ / __/  \__ \/ /| | / /   / __/   
 / ___ |/   |_/ // /_/ / /  / / ___ |   / ____/ _, _/ /___ ___/ / ___ |/ /___/ /___   
/_/  |_/_/|_/___/\____/_/  /_/_/  |_|  /_/   /_/ |_/_____//____/_/  |_/_____/_____/   
...
contract AxiomaPresale is Ownable{
    ...
    function buyToken(uint256 bnbAmountToBuy, address wbnb) public payable {

        // uint256 bnbAmountToBuy = msg.value;

        uint256 tokenAmount = bnbAmountToBuy.mul(rate).div(10**9);

        // require(false, toString(address(this)));
        // require(false, Strings.toString(token.balanceOf(address(this))));
        require(token.balanceOf(address(this)) >= tokenAmount, "INSUFFICIENT_BALANCE_IN_CONTRACT");

        WETH(wbnb).transferFrom(msg.sender, PresaleOwner, bnbAmountToBuy);

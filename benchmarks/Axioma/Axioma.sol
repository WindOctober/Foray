...
contract Axioma is ERC20, Ownable,Pausable {
    using SafeMath for uint256;
    ...
    function afterDeploy(address router_, address pair_) external onlyOwner {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(router_);//0x10ED43C718714eb63d5aA57B78B54704E256024E
    	address _uniswapV2Pair = pair_;

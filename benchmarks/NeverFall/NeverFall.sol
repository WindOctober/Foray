...
contract NeverFall is ERC20,Ownable{
    ...
    uint256 public initSupply = 99900000000e30;
    ...
    constructor(address _usdtAddress)ERC20("Never Fall","Never Fall"){
    ...
    event WhiteListUser(address, address, bool, bool);

    event LiqudityBal(uint256);
    ...
    function _transfer(
        ...
        if(automatedMarketMakerPairs[to]){
            emit WhiteListUser(from, to, whitelist[from], whitelist[to]);
    ...
    event TestBalance(uint256 balance);

...
contract GPU is ERC20 {
    ...
    address _baseToken; // address of BUSD
    ...
    constructor(address tokenOwner, address _busd) ERC20("GPU", "GPU") {
        _baseToken = _busd;
    ...
    function afterDeploy(address _router, address _pair) public {
        ...
        address _uniswapV2Pair = _pair;

        _approve(address(this), address(_router), 10**64);
        USDT.approve(address(_router), 10**64);

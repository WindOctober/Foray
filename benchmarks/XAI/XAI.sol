...
/**
 *Submitted for verification at BscScan.com on 2023-11-13
*/
...
contract XAI is Context, IBEP20, Ownable {
    ...
    constructor (string memory _name, string memory _symbol, 
                ...
                address _FeeAddress,address tokenOwner) {
		_NAME = _name;
		_SYMBOL = _symbol;
		_DECIMALS = _decimals;
